...
//	   if(preference != null){
//		    
//		   LinearLayout reset_uuid_layout = (LinearLayout) findViewById(preference.getLayoutResource());
//		   System.out.println("reset_uuid_layout "+reset_uuid_layout);
//		   if(reset_uuid_layout != null) {
//			   Button resetButton =  (Button) reset_uuid_layout.findViewById(R.id.reset);
//				 
//			   
