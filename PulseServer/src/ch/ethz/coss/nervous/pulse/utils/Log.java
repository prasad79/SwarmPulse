...
public class Log {
	...
	public static synchronized Log getInstance() {
		if (log == null) {
			return new Log(FLAG_ERROR | FLAG_WARNING,
					FLAG_ERROR | FLAG_WARNING, null);
		} else {
			return log;
		}
	}

	public static synchronized Log getInstance(int displayVerbosity,
			int writeVerbosity, String logPath) {
		if (log == null) {
